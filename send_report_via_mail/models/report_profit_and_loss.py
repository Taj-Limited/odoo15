...
class ReportTajProfitExcel(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, partners):
        ...
        sheet.write(0, 10, 'Transit fees Parking Security Fees', bold)
        ...
        sheet.write(0, 24, 'Transit fees Bond ', bold)
        sheet.write(0, 25, 'Transit fees TollRoad', bold)
        sheet.write(0, 26, 'Transit fees GCLA Loading Facilitation Other', bold)
        sheet.write(0, 27, 'Toll Gates going', bold)
        sheet.write(0, 28, 'Return fees Container TAX', bold)
        sheet.write(0, 29, 'Late Exit Note going', bold)
        sheet.write(0, 30, 'Carbon Tax going', bold)
        sheet.write(0, 31, 'Return fees weight pridje', bold)
        sheet.write(0, 32, 'wating charges', bold)
