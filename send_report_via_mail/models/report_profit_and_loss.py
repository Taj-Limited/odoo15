...
class ReportTajProfitExcel(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, partners):
        ...
        sheet.write(0, 46, 'Return fees Entry Card', total_return_details)
        sheet.write(0, 47, 'Return fees Kanyaka', total_return_details)
        sheet.write(0, 48, 'Return fees Levy Council Fee Kapiri', total_return_details)
        sheet.write(0, 49, 'Return fees Penalty over wight', total_return_details)
        sheet.write(0, 50, 'Transit fees Bond', total_return_details)
        sheet.write(0, 51, 'Transit fees Road Toll', total_return_details)
        sheet.write(0, 52, 'Transit fees GCLA Loading Facilitation Other', total_return_details)
        sheet.write(0, 53, 'Toll Gates', total_return_details)
        sheet.write(0, 54, 'Late Exit Note', total_return_details)
        sheet.write(0, 55, 'Return fees Container TAX', total_return_details)
        sheet.write(0, 56, 'Carbon Tax', total_return_details)
        sheet.write(0, 57, 'Return fees weight pridje', total_return_details)
        sheet.write(0, 58, 'wating charges', total_return_details)
        sheet.write(0, 59, 'Return fees Empty Container Offloading Fees', total_return_details)
        sheet.write(0, 60, 'Return fees Visa', total_return_details)
        ...
        for obj in data['products']:
            ...
            sheet.write(row, 46, obj['Return_fees_Entry_Card'], total_return_details)
            sheet.write(row, 47, obj['Return_fees_Kanyaka'], total_return_details)
            sheet.write(row, 48, obj['Return_fees_Levy_Council_Fee_Kapiri'], total_return_details)
            sheet.write(row, 49, obj['Return_fees_Penalty_over_wight'], total_return_details)
            sheet.write(row, 50, obj['Transit_fees_Bond'], total_return_details)
            sheet.write(row, 51, obj['Transit_fees_Road_Toll'], total_return_details)
            sheet.write(row, 52, obj['Transit_fees_GCLA_Loading_Facilitation_Other'], total_return_details)
            sheet.write(row, 53, obj['Toll_Gates'], total_return_details)
            sheet.write(row, 54, obj['Late_Exit_Note'], total_return_details)
            sheet.write(row, 55, obj['Return_fees_Container_TAX'], total_return_details)
            sheet.write(row, 56, obj['Carbon_Tax'], total_return_details)
            sheet.write(row, 57, obj['Return_fees_weight_pridje'], total_return_details)
            sheet.write(row, 58, obj['wating_charges'], total_return_details)
            sheet.write(row, 59, obj['Return_fees_Empty_Container_Offloading_Fees'], total_return_details)
            sheet.write(row, 60, obj['Return_fees_Visa'], total_return_details)
            sheet.write(row, 61, obj['Return_fees_Weight_Check_Tunduma'], total_return_details)
